...
Simply put, C19DP does not have any form of authenticated proviannce. This is however by design, the philosophy of the database is for rapid and immediate access to data and would consider log-in functioanlity as a barrier to data sharing. This design feaute highly benefits users of the platform as their is no lag time between finding and accessing the data. For data producers this lack of authentication is blurry, data producers still have to register a sample or a study with the ENA and EBI, which in practice is a form of authentication, by not signing up to C19DP means data producers only have to register to two institutions rather than three.
